...
public class Combinator {
  /** I(x) = x */
  public static final Instruction I = name("I", instruction1(x -> x));

  /** Y(x) = x(Y(x)) */
  public static final Instruction Y = name("Y", x -> ap(x, ap(Combinator.Y, x)));

  /** K(x)(y) = x */
  public static final Instruction K = name("K", instruction2(x -> y -> x));

  /** S(x)(y)(z) = x(z)(y(z)) */
  public static final Instruction S = name("S",
      instruction3(x -> y -> z -> ap(ap(x, z), ap(y, z))));

  /** C(x)(y)(z) = x(z)(y) */
  public static final Instruction C = name("C", instruction3(x -> y -> z -> ap(ap(x, z), y)));

  /** B(x)(y)(z) = x(y(z)) */
  public static final Instruction B = name("B", instruction3(x -> y -> z -> ap(x, ap(y, z))));
