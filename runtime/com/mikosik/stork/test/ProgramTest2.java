...
public class ProgramTest2 implements Test {
  ...
  private ProgramTest2(String name, Path directory) {
    this.name = name;
    this.directory = directory;
  }

  public static ProgramTest2 programTest(String name) {
    return new ProgramTest2(name, createTempDirectory("stork_test_program_"));
  }

  public ProgramTest2 file(String path, String content) {
    files.put(Paths.get(path), bytes(content));
    return this;
  }

  public ProgramTest2 stdin(String stdin) {
    this.stdin = bytes(stdin);
    return this;
  }

  public ProgramTest2 stdout(String expectedStdout) {
  ...
  public <R> R visit(BiFunction<String, Body, R> caseHandler,
    ...
    return caseHandler.apply(name, () -> ProgramTest2.this.run());
  }
