...
public class TestStream {
  public static Test testStream() {
    return suite("stream")
        ...
        .add(snippetSuite("interlace")
            .importing("lang.stream.interlace")
            .importing("lang.stream.some")
            .importing("lang.stream.none")
            .importing("lang.stream.limit")
            .importing("lang.stream.repeat")
            .test("interlace(some('abc')(some('de')(some('f')(none))))", "adfbec")
            .test("interlace(some('abc')(none))", "abc")
            .test("interlace(some('')(some('')(some('')(none))))", "")
            .test("interlace(some('')(none))", "")
            .test("interlace(some('abc')(some('')(some('def')(none))))", "adbecf")
            .test("interlace(none)", "")
            .test("limit(5)(interlace(repeat('x')))", "xxxxx"))
        ...
        .add(snippetSuite("tryAt")
            ...
            .test("tryAt(3)('abc')((x){x})(-1)", -1)
            .test("tryAt(0)('')((x){x})(-1)", -1))
        .add(snippetSuite("tryFirst")
            .importing("lang.stream.tryFirst")
            .test("tryFirst('abc')((x){x})(-1)", 97)
            .test("tryFirst('')((x){x})(-1)", -1))
